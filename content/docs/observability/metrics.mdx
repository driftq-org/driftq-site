...
<div className="space-y-10">
  ...
  <section className="space-y-5">
    ...
    <div className="space-y-3">
      <div className="rounded-2xl border border-black/10 bg-white/60 px-4 py-3 text-zinc-900 dark:border-white/10 dark:bg-white/5 dark:text-zinc-100">
  ...
  <section className="space-y-4">
    ...
    <div className="rounded-2xl border border-black/10 bg-black/5 p-4 dark:border-white/10 dark:bg-white/5">
      <pre className="m-0 overflow-x-auto"><code>{`# view everything
...
curl -s "http://localhost:8080/metrics" | grep consumer_lag`}</code></pre>
    </div>
