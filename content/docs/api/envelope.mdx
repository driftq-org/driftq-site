...
<div className="space-y-10">
  ...
  <section className="space-y-5">
    ...
    <ul className="space-y-2">
      <li>
        <code>tenant_id</code> — multi-tenant separation / accounting
      </li>
      <li>
        <code>idempotency_key</code> — prevents duplicate side effects across retries
      </li>
      <li>
        <code>deadline</code> — stop doing this work after a certain point in time
      </li>
      <li>
        <code>retry_policy</code> — max attempts + backoff parameters
      </li>
    </ul>
    ...
    <div className="rounded-2xl border border-black/10 bg-black/5 p-4 dark:border-white/10 dark:bg-white/5">
      ...
      <p className="mt-3 mb-0">
        They let producers define reliability and safety expectations <em>once</em>, and DriftQ enforces them consistently.
      </p>
    </div>
  </section>
  ...
  <section className="space-y-5">
    ...
    <div className="rounded-2xl border border-black/10 bg-black/5 px-4 py-3 dark:border-white/10 dark:bg-white/5">
      <p className="m-0">
        <strong>Roadmap note:</strong> DriftQ-Core is the v1 broker. The envelope is what enables DriftQ to grow into a
        workflow engine in v2.
      </p>
    </div>
  </section>
