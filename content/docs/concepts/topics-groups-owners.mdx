...
<div className="space-y-12">
  ...
  <section className="space-y-5">
    ...
    <div className="space-y-2">
      <p className="m-0"><strong>That means:</strong></p>
      <ul className="space-y-2">
    ...
    <div className="space-y-3">
      ...
      <pre className="m-0"><code>{`group=g1  -> offset 10
group=g2  -> offset 72`}</code></pre>

      <p className="m-0">Both are valid and normal.</p>
    </div>
  ...
  <section className="space-y-5">
    ...
    <div className="space-y-2">
      ...
      <p className="m-0">Without an <code>owner</code> + lease model, you risk:</p>
      <ul className="space-y-2">
