...
<div className="space-y-10">
  ...
  <section className="space-y-5">
    ...
    <div className="rounded-2xl border border-black/10 bg-black/5 p-4 dark:border-white/10 dark:bg-white/5">
      <p className="m-0 font-semibold">Example</p>

      <pre className="not-prose mt-3 overflow-x-auto whitespace-pre rounded-2xl border !border-black/10 !bg-zinc-950 px-4 py-3 font-mono text-sm leading-relaxed !text-zinc-100 dark:!border-white/10 dark:!bg-zinc-900 dark:!text-zinc-100">
